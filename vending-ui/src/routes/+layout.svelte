...
<div class="brand-ribbon bg-brand-gradient"></div>
<header>
...
<footer class="footer p-10 bg-neutral text-neutral-content">
    ...
    <div>
      ...
      <a class="link link-hover" href="https://makeuoa.nz/about/creators/join">Get your stuff in here!</a>
    </div> 
    <div>
      <span class="footer-title">Maker Space</span> 
      <a class="link link-hover" href="https://www.cie.auckland.ac.nz/locations/maker-space/">Learn More</a>
    </div>
  </footer>
